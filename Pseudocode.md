...
Step 2: Search all rectangles (classes) in XML
Step 3: For each rectangle found
  • Extract text label as className
  • Create a class representation with name = className
Step 4: Search all associated arrow elements in XML
Step 5: For each solid association arrow found
...
Step 6: Find all inheritance arrows in the XML
Step 7: For each inheritance arrow
...
Step 8: Check all relationships
...
Step 10: Save all generated Java files
